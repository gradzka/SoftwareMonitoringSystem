        ...
        protected void Application_Start()
        {
            ...
            using (var dbContext = new SMSDBContext())
            {
                if (dbContext.Admins.Count()==0)
                {
                    ...
                    {
                        string pAbbrev = BitConverter.ToString(sha512.ComputeHash(Encoding.Default.GetBytes("9CE1EB62332A144B0A752460F9E789B2E4A6D7403D2E18041C4E80352DB736C51FD247301E079CEF9EDE13DFDCF3D040A3F0843E4D92073FDEA29F5838C421F3" + now))).Replace("-", string.Empty);//512 bit hash password
